namespace Windows_Forms_NED
{
    ...
    public partial class Form1 : Form
    {
        ...
        void PreviewCalc()
        {
            ...
            {
                richTextBox2.Text = AsciiEncrypt(inputText, key, Math.Min(recursion, Usersettings.Default.PreviewRec));
            }
            else
            {
                richTextBox2.Text = AsciiDecrypt(inputText, key, Math.Min(recursion, Usersettings.Default.PreviewRec));
            }
        }
